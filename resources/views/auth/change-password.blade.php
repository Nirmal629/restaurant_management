...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Change Password | Restaurant OS</title>
        ...
        <div class="min-h-screen grid lg:grid-cols-[42%_58%]">
            <div class="relative hidden overflow-hidden bg-slate-900 px-8 py-10 text-white lg:flex lg:flex-col lg:justify-between">
                ...
                <div class="relative z-10">
                    ...
                    <div class="max-w-md">
                        <p class="mb-4 text-sm font-medium uppercase tracking-[0.25em] text-brand-300">Account Security</p>
                        <h2 class="text-4xl font-bold leading-tight">Keep your staff accounts protected and compliant.</h2>
                        <p class="mt-5 max-w-md text-base text-slate-300">
                            Periodic password changes reduce risk and help maintain safe access to the restaurant management system.
                        </p>
                    </div>
                </div>

                <div class="relative z-10 rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
                    <p class="text-xs uppercase tracking-[0.2em] text-slate-300">Best practice</p>
                    <p class="mt-2 text-lg font-semibold">Use a unique password, never share credentials.</p>
                </div>
            </div>
                ...
                <div class="w-full max-w-md">
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
                        <div class="mb-6 flex items-start justify-between gap-3">
                            <div>
                                <p class="text-sm font-medium uppercase tracking-[0.2em] text-brand-600">Profile</p>
                                <h2 class="mt-2 text-3xl font-bold text-slate-900">Change password</h2>
                            </div>
