...
<x-pos.dialog name="merge" width="max-w-lg" title="Merge Table">
    ...
    <x-slot:footer>
        <div class="flex gap-2">
            ...
            <button type="button" @click="confirmMerge()" :disabled="!mergeDraft.secondaryId"
                    class="h-10 flex-1 rounded-md bg-slate-900 text-[12px] font-black uppercase tracking-wide text-white hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-300">Merge Tables</button>
        </div>
    </x-slot:footer>
</x-pos.dialog>
