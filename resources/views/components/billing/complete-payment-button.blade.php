...
<div class="pos-dock border-t border-slate-200 bg-white p-2.5">
    <button type="button" @click="completePayment()" :disabled="dueAmount > 0"
            :class="dueAmount > 0 ? 'cursor-not-allowed bg-slate-100 text-slate-400' : 'bg-emerald-600 text-white hover:bg-emerald-500'"
